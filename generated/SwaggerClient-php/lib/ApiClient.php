...
class ApiClient
{
     ...
     */
    public function __construct(\severr\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \severr\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\severr\ObjectSerializer::sanitizeForSerialization($postData));
        }
